...
import com.qihoo.cache.store.impl.BasicDataStore;
 ...
 */
public class SoCache<K, V> implements Cache<K, V> {
    ...
    private SoCacheManager cacheManager;

    private Configuration<K, V> configuration;

    public SoCache(SoCacheManager cacheManager, String cacheName, Configuration<K, V> configuration) {
